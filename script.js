...
async function showGallery(villaName, startIndex) {
    ...
    let currentImage= `https://github.com/UjjawalSaran2002/Al-Malah/tree/main/images/${villaName}`
    var galleryContent = document.getElementById('gallery-content');
    galleryContent.innerHTML=galleryContent.innerHTML+`https://github.com/UjjawalSaran2002/Al-Malah/tree/main/images/${villaName}/image2.jpg" alt=""></img>`
...
//     //     var img = document.createElement('img');
//     //     img.src = "https://github.com/UjjawalSaran2002/Al-Malah/tree/main/images/"+imageFolder +"/"+ images[index];
...
//     selectedImage.src = `https://github.com/UjjawalSaran2002/Al-Malah/tree/main/images/${imageFolder}/${images[selectedIndex]}`;
...
//         if (i !== selectedIndex) {
//             var img = document.createElement('img');
//             img.src = `https://github.com/UjjawalSaran2002/Al-Malah/tree/main/images/${imageFolder}/${images[i]}`;
...
async function getImageList(folderName){
    let a =await fetch(`https://github.com/UjjawalSaran2002/Al-Malah/tree/main/images/${folderName}/`)
...
async function getFolderList(){
    let a =await fetch("https://github.com/UjjawalSaran2002/Al-Malah/tree/main/images/")
    let response=await a.text()
...
async function main(){
    ...
    for (const i in folderList ) { //this for loop is to create multiple cards
        ...
        <img src="https://github.com/UjjawalSaran2002/Al-Malah/tree/main/images/${folderList[i]}/${folderList[i]}_thumb.jpeg" alt="${folderList[i]}">
