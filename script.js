...
async function showGallery(villaName, startIndex) {
    ...
    let currentImage= `https://app.netlify.com/start/deploy?repository=https://github.com/UjjawalSaran2002/Al-Malah/images/${villaName}`
    var galleryContent = document.getElementById('gallery-content');
    galleryContent.innerHTML=galleryContent.innerHTML+`https://app.netlify.com/start/deploy?repository=https://github.com/UjjawalSaran2002/Al-Malah/images/${villaName}/image2.jpg" alt=""></img>`
...
//     //     var img = document.createElement('img');
//     //     img.src = "https://app.netlify.com/start/deploy?repository=https://github.com/UjjawalSaran2002/Al-Malah/images/"+imageFolder +"/"+ images[index];
...
//     selectedImage.src = `https://app.netlify.com/start/deploy?repository=https://github.com/UjjawalSaran2002/Al-Malah/images/${imageFolder}/${images[selectedIndex]}`;
...
//         if (i !== selectedIndex) {
//             var img = document.createElement('img');
//             img.src = `https://app.netlify.com/start/deploy?repository=https://github.com/UjjawalSaran2002/Al-Malah/images/${imageFolder}/${images[i]}`;
...
async function getImageList(folderName){
    let a =await fetch(`https://app.netlify.com/start/deploy?repository=https://github.com/UjjawalSaran2002/Al-Malah/images/${folderName}/`)
...
async function getFolderList(){
    let a =await fetch("https://app.netlify.com/start/deploy?repository=https://github.com/UjjawalSaran2002/Al-Malah/images/")
    let response=await a.text()
...
async function main(){
    ...
    for (const i in folderList ) { //this for loop is to create multiple cards
        ...
        <img src="https://app.netlify.com/start/deploy?repository=https://github.com/UjjawalSaran2002/Al-Malah/images/${folderList[i]}/${folderList[i]}_thumb.jpeg" alt="${folderList[i]}">
